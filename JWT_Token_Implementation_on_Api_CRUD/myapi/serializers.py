from rest_framework import serializers  # Importing serializers from rest_framework module
from rest_framework_simplejwt.tokens import RefreshToken  # Importing RefreshToken from rest_framework_simplejwt.tokens module
